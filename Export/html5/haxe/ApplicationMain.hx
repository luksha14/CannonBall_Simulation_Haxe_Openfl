...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("CannonSimulation", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("CannonSimulation", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "CannonSimulation";
		app.meta["name"] = "Cannon Simulation";
		app.meta["packageName"] = "com.sample.cannonsimulation";
		...
		#elseif air
		app.window.title = "Cannon Simulation";
		#else
